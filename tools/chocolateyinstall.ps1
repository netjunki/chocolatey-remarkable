...
$url        = 'https://downloads.remarkable.com/desktop/production/win/reMarkable-3.3.0.732-win32.exe'
$url64      = 'https://downloads.remarkable.com/desktop/production/win/reMarkable-3.3.0.732-win32.exe'
