...
$url        = 'https://downloads.remarkable.com/latest/windows' # download url, HTTPS preferred
$url64      = 'https://downloads.remarkable.com/latest/windows' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  # MSI
  silentArgs    = "in --al --da -c" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
